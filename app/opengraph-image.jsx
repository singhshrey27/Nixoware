  ...
  return new ImageResponse(
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '64px 72px', color: '#ffffff', background: '#071b31', fontFamily: 'Arial, sans-serif' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 20 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}><strong style={{ fontSize: 42, letterSpacing: 1 }}>NIXOWARE</strong><span style={{ fontSize: 12, letterSpacing: 3, color: '#a9c4df' }}>SOFTWARE INNOVATION SERVICES</span></div>
      </div>
